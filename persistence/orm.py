...
class Port(Base):
    ...
    ip_cdn: Mapped[Union[None, str]] = mapped_column(String(128), nullable=True)
...
class Domain(Base):
    ...
    host_cdn: Mapped[str] = mapped_column(String(128), nullable=True)
    ...
    a_cdn: Mapped[[Union[None, str]]] = mapped_column(ARRAY(String(128)), nullable=True)

    aaaa: Mapped[[IPv6Address]] = mapped_column(ARRAY(INET()), nullable=True)
    aaaa_cdn: Mapped[[Union[None, str]]] = mapped_column(ARRAY(String(128)), nullable=True)
...
class WebInfo(Base):
    ...
    ip_cdn: Mapped[str] = mapped_column(String(128), nullable=True)
